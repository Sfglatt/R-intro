...
number_vector[2]  # Enclose the position of the value you want to see in square brackets. [2] will yield the 2nd number in the vector
...
# Import data
```{r data}
# This is the basic argument to import data.
data <- read.csv("01_data.csv") # This is a toy dataset that you can create in '02_simulate_data.Rmd'
...
# Just like the vectors, you can change columns to numeric/character/factor with as.numeric(), as.factor(), and as.numeric()
...
data <- data %>%
  dplyr::mutate(
    sum_score_bdi = rowSums(
      dplyr::select(., # The ., tells dplyr to use the 'data' object. You can also use the name of the dataset there instead

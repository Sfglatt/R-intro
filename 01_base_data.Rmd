...
# Create a folder called "01_Output". This folder will be created in your working directory. 
dir.create("01_Output")

# Now, you can save the data as a CSV in '01_Output':
write.csv(data, # The dataset object that you want to save
          "01_Output/Scored_data.csv") # The folder it should be saved in (within the working directory), and the name of the new file.
...
write.csv(data, paste0("01_Output/Scored_data_", Sys.Date(), ".csv")) 
...
write_xlsx(data, paste0("01_Output/Scored_data_", Sys.Date(), ".xlsx")) 
...
write_sav(data, paste0("01_Output/Scored_data_", Sys.Date(), ".sav"))
...
write.csv(summary_df, # The summary object from summary_df <- psych::describe(data)
          paste0("01_Output/Summary_", Sys.Date(), ".csv")) 
```

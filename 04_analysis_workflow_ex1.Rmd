---
title: "04_analysis_workflow_ex1"
author: "Sglatt"
date: "`r Sys.Date()`"
...
pdf("04_Output/EGA_plot.pdf", width = 10, height = 10) 
...
pdf("04_output/EGA_item_stability.pdf", width = 10, height = 10)
dimensionStability(boot_ega_object)
dev.off()

# To save the figures as a PNG file, 

png("04_Output/EGA_plot.png", width = 1000, height = 1000) 
...
png("04_Output/EGA_item_stability.png", width = 1000, height = 1000)
dimensionStability(boot_ega_object)
dev.off()
```
